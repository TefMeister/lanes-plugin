> **Retired 2026-09-26.** The banner is now finished artwork with no text to keep current (see
> `../README.md`). Everything below describes the old pipeline, kept here unchanged. The last banner
> it drew is `banner-0.23.1.png`.
